...
const TRANSLATIONS: Record<Lang, Record<TKey, string>> = {
  en: {
    appTitle: "ADAPT-SCAN",
    appSubtitle: "ADAPTIVE EW SENSING DECISION ENGINE",
    ...
    currentIntel: "CURRENT INTELLIGENCE",
    detected: "Detected",
    ...
    spectrumEnv: "SPECTRUM / ENVIRONMENT",
    ...
    currentMetrics: "CURRENT RUN METRICS",
    scansExecuted: "Scans Executed",

    signalsDetected: "Signals Detected",
    avgInfoGain: "Avg Info Gain",
    avgThreatVal: "Avg Threat Val",

    detectionRate: "Detection Rate",
    infoGain: "Info Gain",
    threatValue: "Threat Relevance",

    trackUrgency: "Track Urgency",
    scanCost: "Scan Cost",

    aiAssistant: "AI ASSISTANT",
    aiPlaceholder: "Ask about ADAPT-SCAN…",
    send: "SEND",

    aiGreet:
      "Hello! I can explain ADAPT-SCAN concepts, strategies, and the simulation. What would you like to know?",

    langLabel: "LANG",
    footerLeft: "SIH2026 · PS26055 · ADAPT-SCAN",
  ...
  hi: {
    appTitle: "ADAPT-SCAN",
    appSubtitle: "अनुकूली EW संवेदन निर्णय इंजन",
    ...
    emitters: "उत्सर्जक",
    noiseLevel: "शोर स्तर",
    scanBudget: "स्कैन बजट",
    speedMs: "गति (ms)",

    dynamicEvents: "गतिशील घटनाएं",
    on: "चालू",
    off: "बंद",
    scenario: "परिदृश्य",

    runStrategy: "रणनीति चलाएं",
    strategyComparison: "रणनीति तुलना",

    currentMetrics: "वर्तमान मेट्रिक्स",
    scansExecuted: "स्कैन निष्पादित",

    signalsDetected: "संकेत पहचाने",
    avgInfoGain: "औसत सूचना लाभ",
    avgThreatVal: "औसत खतरा मूल्य",

    detectionRate: "पहचान दर",
    infoGain: "सूचना लाभ",
    threatValue: "खतरा प्रासंगिकता",

    trackUrgency: "ट्रैक तात्कालिकता",
    scanCost: "स्कैन लागत",

    aiAssistant: "AI सहायक",
    aiPlaceholder: "ADAPT-SCAN के बारे में पूछें…",
    send: "भेजें",
  ...
  fr: {
    appTitle: "ADAPT-SCAN",
    appSubtitle: "MOTEUR DE DÉCISION ADAPTATIF EW",
    ...
    currentIntel: "RENSEIGNEMENT ACTUEL",
    detected: "Détecté",
    ...
    spectrumEnv: "SPECTRE / ENVIRONNEMENT",
    ...
    emitters: "Émetteurs",
    noiseLevel: "Bruit",
    scanBudget: "Budget Scan",
    speedMs: "Vitesse (ms)",

    dynamicEvents: "Dynamique",
    on: "OUI",
    off: "NON",
    scenario: "Scénario",

    runStrategy: "EXÉCUTER",
    strategyComparison: "COMPARAISON",
    currentMetrics: "MÉTRIQUES",

    scansExecuted: "Scans",
    signalsDetected: "Signaux",
    avgInfoGain: "Info Moy.",
    avgThreatVal: "Menace Moy.",

    detectionRate: "Taux Détection",
    infoGain: "Gain Info",
    threatValue: "Menace",

    trackUrgency: "Urgence",
    scanCost: "Coût Scan",
  ...
  es: {
    appTitle: "ADAPT-SCAN",
    appSubtitle: "MOTOR ADAPTATIVO DE DECISIÓN EW",
    ...
    currentIntel: "INTELIGENCIA ACTUAL",
    detected: "Detectado",
    highPriority: "Alta Prioridad",

    uncertain: "Incierto",
    budgetUsed: "Presupuesto",
    scanning: "Escaneando",

    spectrumEnv: "ESPECTRO / ENTORNO",
    ...
    emitters: "Emisores",
    noiseLevel: "Ruido",
    scanBudget: "Presupuesto Scan",
    speedMs: "Velocidad (ms)",

    dynamicEvents: "Dinámico",
    on: "SÍ",
    off: "NO",
    scenario: "Escenario",

    runStrategy: "EJECUTAR",
    strategyComparison: "COMPARACIÓN",
    currentMetrics: "MÉTRICAS",

    scansExecuted: "Scans",
    signalsDetected: "Señales",
    avgInfoGain: "Info Prom.",
    avgThreatVal: "Amenaza Prom.",

    detectionRate: "Tasa Detección",
    infoGain: "Ganancia Info",
    threatValue: "Amenaza",

    trackUrgency: "Urgencia",
    scanCost: "Costo Scan",

    aiAssistant: "ASISTENTE IA",
    aiPlaceholder: "Pregunta sobre ADAPT-SCAN…",
    send: "ENVIAR",
  ...
  de: {
    appTitle: "ADAPT-SCAN",
    appSubtitle: "ADAPTIVES EW-SENSOR-ENTSCHEIDUNGSSYSTEM",
    ...
    currentIntel: "AKTUELLE AUFKLÄRUNG",
    detected: "Erkannt",
    ...
    noiseLevel: "Rauschen",
    scanBudget: "Scan-Budget",
    speedMs: "Geschwindigkeit (ms)",

    dynamicEvents: "Dynamisch",
    on: "AN",
    off: "AUS",
    scenario: "Szenario",
    ...
    currentMetrics: "METRIKEN",

    scansExecuted: "Scans",
    signalsDetected: "Signale",
    avgInfoGain: "Ø Info",
    avgThreatVal: "Ø Bedrohung",

    detectionRate: "Erkennungsrate",
    infoGain: "Infogewinn",
    threatValue: "Bedrohung",

    trackUrgency: "Dringlichkeit",
    scanCost: "Kosten",

    aiAssistant: "KI-ASSISTENT",
    aiPlaceholder: "Frag über ADAPT-SCAN…",
    send: "SENDEN",
...
function getAIResponse(
  ...
  if (/hello|hi|hey/.test(q))
    return "Hello! Ask me about ADAPT-SCAN's algorithm, strategies, or the current simulation state."

  if (/adapt.?scan|how does it work/.test(q))
    return "ADAPT-SCAN maximizes: InfoGain×0.38 + ThreatValue×0.35 + TrackingUrgency×0.17 − ScanCost. It maintains a POMDP belief state and selects the highest-utility region each step."

  if (/pomdp|partial|belief/.test(q))
    return "The POMDP model maintains belief state B(s) — a probability distribution over emitter states. After each scan, beliefs update via Bayesian inference: detected → beliefProb×0.3+0.65, not detected → beliefProb×0.6."

  if (/info.?gain/.test(q))
    return "Information Gain (weight 0.38) = uncertainty × staleness. Regions not scanned recently with high uncertainty score highest. Staleness = (current_step − last_scan) / 12."

  if (/threat/.test(q))
    return "Threat Value (weight 0.35) = threatLevel × priority. High-threat RADAR/ECM signals in high-priority regions score highest, directing the AI toward tactically important spectrum."

  if (/track|urgency/.test(q))
    return "Tracking Urgency (weight 0.17) = 0.6×staleness + 0.4×uncertainty. Ensures continuous surveillance of behaviorally changing or uncertain regions."

  if (/cost/.test(q))
    return "Scan Cost = 0.08 + (1−priority)×0.15. Low-priority regions cost more relative to their value. The denominator in the utility function naturally penalizes expensive, low-value scans."

  if (/random|round.?robin/.test(q))
    return "RANDOM: ~41% detection (baseline). ROUND-ROBIN: ~58% (cyclic, ignores environment). THREAT-PRIORITY: ~67% (reactive but no info gain). ADAPT-SCAN: ~83%+ (full POMDP utility)."

  if (/override/.test(q))
    return "Human-in-the-Loop: operators can override the AI's recommendation using the OVERRIDE button. The system records the intervention in the decision timeline, demonstrating collaborative AI decision support."

  if (/confidence/.test(q))
    return "Confidence reflects how decisively ADAPT-SCAN selected the current region over alternatives. High confidence means a clear utility gap between the top candidate and alternatives."

  if (/current|status|running/.test(q)) {
    const det = history.filter((r) => r.detectedSignal).length

    return `Step ${step}: ${history.length} scans, ${det} detections (${
      history.length ? Math.round((det / history.length) * 100) : 0
    }% rate). Avg info gain: ${
      history.length
        ? (
            history.reduce((s, r) => s + r.infoGain, 0) / history.length
          ).toFixed(3)
        : "n/a"
    }.`
  }

  if (/sih|ps26055|hackathon/.test(q))
    return "SIH 2026 Problem Statement PS26055: Smart Scan Strategy for Electronic Warfare. ADAPT-SCAN demonstrates intelligent sensing that outperforms naive strategies through POMDP-based decision making."
...
function selectNext(
  ...
  let best = regions[0],
    bestU = computeUtility(regions[0], step, strategy)
...
const SCENARIOS = [
  {
    id: "NORMAL",
    label: "Normal",
    desc: "Low complexity, low uncertainty",
    difficulty: "Easy",
    challenge: "Baseline sensing",
...

  {
    id: "DYNAMIC",
    label: "Dynamic Env",
    desc: "Changing emitters",
    difficulty: "Medium",
    challenge: "Adaptive tracking",
...

  {
    id: "HIGH_NOISE",
    label: "High Noise",
    desc: "Reduced observation quality",
    difficulty: "Hard",
...

  {
    ...
    desc: "Resource-constrained sensing",
    difficulty: "Hard",
    challenge: "Budget efficiency",
...

  {
    id: "SUDDEN",
    label: "Sudden Threat",
    desc: "New high-priority emitter",
    difficulty: "Medium",
    challenge: "Rapid reallocation",
...

  {
    ...
    desc: "Large information gaps",
    difficulty: "Expert",
    challenge: "Belief management",
...

  {
    id: "STRESS",
    label: "Stress Test",
    desc: "Multiple simultaneous changes",
    difficulty: "Expert",
...
function MiniChart({
  ...
  const pts = data.map(
    (v, i) =>
      `${(i / (data.length - 1)) * w},${height - 4 - ((v - mn) / r) * (height - 8) + 2}`,
  )
...
function StatusChip({ status, c }: { status: string c: Palette }) {
  ...
  return (
    <span
      className="mono text-[9px] px-1.5 py-0.5 rounded-sm font-bold tracking-wider"
      style={{
        background: color + "22",
        color,
...
function Bar({
  ...
  return (
    <div className="space-y-0.5">
      ...
      {expl && (
        <div
          className="text-[9px] mono ml-28 pl-2"
          style={{ color: "#4a7a99" }}
        >
          {expl}
        </div>
    ...
    <div className="space-y-1.5">
      {candidates.slice(0, 4).map((cand, i) => (
        <div key={cand.id} className="flex items-center gap-1.5">
          <span
            className="text-[9px] mono w-4"
            style={{ color: i === 0 ? c.accent : c.textVeryDim }}
          >
            {i === 0 ? "●" : "○"}
          </span>
          <span
            className="mono text-[10px] w-5 font-bold"
            style={{ color: i === 0 ? c.textPrimary : c.textMuted }}
          >
            {cand.id}
          </span>
          <span
            className="mono text-[9px] w-12"
            style={{
              color: i === 0 ? c.accent : i === 1 ? c.blue : c.textVeryDim,
            }}
          >
            {i === 0 ? "RECOM." : i === 1 ? "ALT." : ""}
          </span>
          ...
          >
            <div
              ...
              style={{
                width: `${(cand.utility / maxU) * 100}%`,
                background: i === 0 ? c.accent : i === 1 ? c.blue : c.textMuted,
              }}
            />
          </div>
          <span
            className="mono text-[9px] w-7 text-right"
...
function BeliefUpdateCard({ delta, c }: { delta: ScanDelta c: Palette }) {
  ...
  const uBef = Math.round(delta.uncBefore * 100),
    uAft = Math.round(delta.uncAfter * 100)
  ...
  return (
    <div
      ...
      style={{ background: c.bgDarkCard, border: `1px solid ${c.border}` }}
    >
      <div
        className="mono text-[9px] tracking-widest font-bold"
        style={{ color: c.textMuted }}
      >
        BELIEF UPDATE — {delta.regionId}
      </div>
      <div className="flex items-center gap-2 text-[10px] mono">
        <span style={{ color: c.textMuted }} className="w-20 shrink-0">
          Confidence
        </span>
        <span style={{ color: c.textVeryDim }}>{bBef}%</span>
        <span style={{ color: c.textVeryDim }}>→</span>
        <span style={{ color: up ? c.accent : c.red, fontWeight: "bold" }}>
          {bAft}%
        </span>
        <span style={{ color: up ? c.accent : c.red }} className="text-[9px]">
          {up ? "▲" : "▼"} {Math.abs(bAft - bBef)}pp
        </span>
      </div>
      <div className="flex items-center gap-2 text-[10px] mono">
        <span style={{ color: c.textMuted }} className="w-20 shrink-0">
        ...
        {uAft < uBef && (
          <span style={{ color: c.blue }} className="text-[9px]">
            ▼ resolved
          </span>
        )}
      </div>
      <div className="flex items-center gap-2 text-[10px] mono">
        ...
        <span
          style={{
            color: getStatusColor(delta.statusAfter, c),
            fontWeight: "bold",
          }}
        >
          {delta.statusAfter}
...
function DecisionPanel({
  ...
  currentRecord: ScanRecord | null
  candidates: Candidate[]
  lastDelta: ScanDelta | null
  ...
  return (
    <div
      className="w-[300px] shrink-0 flex flex-col border-l overflow-y-auto"
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <div
            ...
            style={{
              background: running ? c.accent : c.yellow,
      ...
      <div className="p-4 space-y-4 flex-1">
        {!currentRecord ? (
          <div
            className="text-[10px] mono text-center py-8"
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <div
                  className="mono text-[9px] tracking-widest mb-1"
                  style={{ color: c.textMuted }}
                >
                  NEXT ACTION
                </div>
            ...
            >
              ...
              <div
                className="flex items-center gap-1.5 text-[9px] mono"
                style={{ color: c.textMuted }}
              >
            ...
            <div className="space-y-2.5">
              <Bar
                label={t("infoGain")}
                value={currentRecord.infoGain}
                color={c.accent}
                expl={factorExplanation("ig", currentRecord.infoGain)}
                trackBg={c.bgTrack}
              />
              <Bar
                label={t("threatValue")}
                value={currentRecord.threatValue}
                color={c.red}
                expl={factorExplanation("tv", currentRecord.threatValue)}
                trackBg={c.bgTrack}
              />
              <Bar
                label="Uncertainty"
                value={currentRecord.uncertainty}
                color={c.purple}
                expl={factorExplanation("unc", currentRecord.uncertainty)}
                trackBg={c.bgTrack}
              />
              <Bar
                label={t("trackUrgency")}
                value={currentRecord.trackingUrgency}
                color={c.yellow}
                expl={factorExplanation("tu", currentRecord.trackingUrgency)}
                trackBg={c.bgTrack}
              />
              <Bar
                label={t("scanCost")}
                value={currentRecord.scanCost}
                color={c.textMuted}
                expl={factorExplanation("cost", currentRecord.scanCost)}
                trackBg={c.bgTrack}
              />
            </div>
            ...
            {showReasonFull && (
              <div
                className="rounded p-2.5 text-[10px] mono leading-relaxed"
                style={{
            ...
            <div>
              <div
                className="mono text-[9px] tracking-widest mb-2 font-bold"
                style={{ color: c.textMuted }}
              >
                CANDIDATE SCANS
              </div>
              ...
              <>
                ...
                {showWhyNot && candidates[1] && (
                  ...
                  >
                    ...
                    {[
                      {
                        label: "Higher info gain",
                        ok: candidates[0].infoGain > candidates[1].infoGain,
                      },

                      {
                        label: "Greater threat value",
                        ok:
                          candidates[0].threatScore > candidates[1].threatScore,
                      },

                      { label: "Comparable scan cost", ok: true },

                      {
                        label: "Superior overall utility",
                        ok:
                          candidates[0].utility > candidates[1].utility * 1.05,
                      },
                    ].map(({ label, ok }) => (
                      <div
                        key={label}
                        className="flex items-center gap-1.5 text-[9px] mono"
                      >
                        <span style={{ color: ok ? c.accent : c.textVeryDim }}>
                          {ok ? "✓" : "·"}
                        </span>
                        <span
                          style={{ color: ok ? c.textInfo : c.textVeryDim }}
                        >
                          {label}
                        </span>
                      </div>
                    ...
                    <div
                      className="text-[9px] mono mt-1 pt-1.5 border-t"
                      style={{ borderColor: c.border, color: c.textVeryDim }}
                    >
                      Utility margin: +
                      {(
                        ((candidates[0].utility - candidates[1].utility) /
                          candidates[1].utility) *
                        100
                      ).toFixed(0)}
                      % over {candidates[1].id}
                    </div>
                  </div>
                )}
              </>
...
function Sidebar({
  ...
  return (
    <div
      ...
      style={{ width: 180, background: c.bgPanel, borderColor: c.border }}
    >
      {/* Logo */}
      <div className="px-4 py-4 border-b" style={{ borderColor: c.border }}>
        <div className="flex items-center gap-2">
          <div
            ...
            style={{
              background: running ? c.accent : c.yellow,
              boxShadow: running ? `0 0 8px ${c.accent}` : "none",
            }}
          />
          <span
        ...
        <div
          className="mono text-[9px] mt-1 tracking-wider"
          style={{ color: c.textVeryDim }}
        >
          PS26055 · SIH 2026
        </div>
      ...
      <div className="flex-1 py-2">
        {NAV_ITEMS.map((item) => (
          <button
            ...
            style={{
              background:
                activePage === item.page ? c.accent + "18" : "transparent",
...
function EmittersPage({
  ...
  const [sortBy, setSortBy] =
    useState<"id" | "threat" | "confidence" | "uncertainty">("confidence")
    ...
    <div className="flex flex-1 overflow-hidden">
      <div className="flex-1 overflow-auto p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <div
              ...
              style={{ color: c.textVeryDim }}
            >
              {regions.filter((r) => r.active).length} active emitters across{" "}
              {regions.length} monitored regions
            </div>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="mono text-[9px]" style={{ color: c.textVeryDim }}>
              SORT:
            </span>
            {colBtn("id", "ID")} {colBtn("confidence", "CONF")}{" "}
            {colBtn("threat", "THREAT")} {colBtn("uncertainty", "UNC")}
          </div>
        </div>
        ...
        >
          {/* Header */}
          <div
            className="grid mono text-[9px] tracking-widest px-3 py-2 border-b"
            style={{
          ...
          {sorted.map((r) => {
            ...
            const staleness =
              r.lastScanned < 0 ? "NEVER" : `T-${step - r.lastScanned}`
            ...
            return (
              <div
                ...
                style={{
                  gridTemplateColumns:
                    "44px 1fr 100px 80px 80px 60px 70px 80px",
              ...
              >
                ...
                <span>
                  <span
                    style={{ color: r.active ? c.textPrimary : c.textVeryDim }}
                    className="font-bold"
                  >
                    {r.id}
                  </span>
                  <span style={{ color: c.textMuted }} className="ml-1.5">
                    {r.freqMHz}MHz
                  </span>
                  <span
                    className="ml-1.5 text-[8px] px-1 rounded"
                    style={{
                      background: TYPE_COLOR[r.signalType] + "22",
                      color: TYPE_COLOR[r.signalType],
                    }}
                  >
                    {r.signalType}
                  </span>
                ...
                <span>
                  <span
                    ...
                    className="font-bold"
                  >
                    {Math.round(r.beliefProb * 100)}%
                  </span>
                </span>
                <span
                  style={{
                    color: r.uncertainty > 0.65 ? c.purple : c.textMuted,
                  }}
                >
      ...
      {selected && (
        <div
          className="w-64 border-l overflow-y-auto p-4 space-y-3 shrink-0"
          style={{ borderColor: c.border, background: c.bgPanel }}
        >
          ...
          <div className="space-y-1.5 text-[10px] mono">
            {[
              [
                "Emitter ID",
                `E-${String(sorted.indexOf(selected) + 1).padStart(2, "0")}`,
              ],

              ["Region", selected.id],
              ["Frequency", `${selected.freqMHz} MHz`],

              ["Bandwidth", `${selected.bwMHz} MHz`],
              ["Signal Class", selected.signalType],

              [
                "Signal Strength",
                (selected.signalStrength * 100).toFixed(0) + "%",
              ],
              ...
              [
                "Threat Relevance",
                (selected.threatLevel * 100).toFixed(0) + "%",
              ],

              [
                "Priority",
                selected.priority > 0.66
                  ? "HIGH"
                  : selected.priority > 0.33
                    ? "MED"
                    : "LOW",
              ],
              ...
              [
                "Last Observed",
                selected.lastScanned < 0
                  ? "Never"
                  : `Step ${selected.lastScanned}`,
              ],
              ...
              <div key={k} className="flex justify-between gap-2">
                ...
                <span style={{ color: c.textInfo }} className="text-right">
                  {v}
                </span>
              </div>
            ))}
          ...
          <div>
            <div
              className="mono text-[9px] tracking-widest mb-2"
              style={{ color: c.textMuted }}
            >
              BELIEF CONFIDENCE
            </div>
            ...
            >
              <div
                ...
                style={{
                  width: `${selected.beliefProb * 100}%`,
                  background:
                    selected.beliefProb > 0.7
                      ? c.accent
                      : selected.beliefProb > 0.4
                        ? c.yellow
                        : c.textMuted,
                }}
              />
            ...
            <div
              className="mono text-[9px] tracking-widest mb-2 mt-3"
              style={{ color: c.textMuted }}
            >
              UNCERTAINTY
            </div>
            ...
            >
              <div
                className="h-full rounded-full"
                style={{
                  width: `${selected.uncertainty * 100}%`,
                  background: c.purple,
                }}
              />
            </div>
    ...
    <div className="flex-1 overflow-auto p-5">
      <div className="mb-4">
        ...
        <div
          ...
          style={{ color: c.textVeryDim }}
        >
          {events.length} events recorded · click to expand
        </div>
      </div>
      <div className="space-y-1.5 max-w-3xl">
        {events.length === 0 && (
          <div
            className="mono text-[10px] py-8 text-center"
            style={{ color: c.textVeryDim }}
          >
            — start simulation to record decisions —
          </div>
        )}
        {[...events].reverse().map((ev) => (
          <div key={ev.id}>
            ...
            >
              <span
                className="mono text-[9px] w-14 shrink-0"
                style={{ color: c.textVeryDim }}
              >
                {formatT(ev.elapsed)}
              </span>
              ...
              <span
                className="mono text-[10px] flex-1"
              ...
              {ev.detected !== undefined && (
                <span
                  ...
                  style={{ color: ev.detected ? c.accent : c.textVeryDim }}
                >
                  {ev.detected ? "HIT" : "NIL"}
                </span>
              )}
            ...
            {expanded === ev.id && ev.record && (
              <div
                className="mx-3 mb-1 px-3 py-2.5 rounded-b border-x border-b space-y-1.5"
                style={{ borderColor: c.border, background: c.bgIntel }}
              >
                <div
                  className="mono text-[9px] font-bold mb-1"
                  style={{ color: c.textMuted }}
                >
                  WHAT HAPPENED
                </div>
                <div className="text-[9px] mono" style={{ color: c.textInfo }}>
                  {ev.record.explanation}
                </div>
...
function AnalyticsPage({
  ...
  const avgIG = history.length
    ? history.reduce((s, r) => s + r.infoGain, 0) / history.length
    : 0

  const avgTV = history.length
    ? history.reduce((s, r) => s + r.threatValue, 0) / history.length
    : 0

  const avgUnc = regions.length
    ? regions.reduce((s, r) => s + r.uncertainty, 0) / regions.length
    : 0

  const igOverTime = history
    .slice()
    .reverse()
    .map((r) => r.infoGain)

  const detOverTime = history
    .slice()
    .reverse()
    .map((_, i, arr) => {
  ...
  const tiles = [
    {
      ...
      value: `${Math.round(detRate * 100)}%`,
      color: c.accent,
      sub: "signals found / scans",
    },

    {
      label: "Avg Info Gain",
      value: avgIG.toFixed(3),
      color: c.blue,
      sub: "per scan decision",
    },

    {
      label: "Threat Coverage",
      value: `${Math.round(avgTV * 100)}%`,
      color: c.red,
      sub: "avg threat relevance",
    },

    {
      label: "Avg Uncertainty",
      value: `${Math.round(avgUnc * 100)}%`,
      color: c.purple,
      sub: "current across regions",
    },
...

    {
      ...
      value: regions.filter((r) => r.beliefProb > 0.7 && r.active).length,
      color: c.accent,
      sub: "belief > 70%",
    },
  ]
    ...
    <div className="flex-1 overflow-auto p-5 space-y-6">
      <div>
        ...
        <div
          ...
          style={{ color: c.textVeryDim }}
        >
          Research-grade performance metrics · {history.length} observations
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        {tiles.map((tile) => (
          <div
            ...
            style={{ background: c.bgDarkCard, borderColor: c.border }}
          >
            <div
              className="mono text-[9px] tracking-widest"
              style={{ color: c.textMuted }}
        ...
        {[
          {
            ...
            data: detOverTime,
            color: c.accent,
            q: "Is the AI finding more signals as it learns?",
          },

          {
            ...
            data: uncOverTime,
            color: c.purple,
            q: "Is belief state being resolved by scanning?",
          },

          {
            title: "INFORMATION GAIN PER SCAN",
            data: igOverTime,
            color: c.blue,
            q: "Is the AI selecting high-value observations?",
          },

          {
            ...
            data: history
              ...
              .map((r) => r.threatValue),
            color: c.red,
            q: "Is the AI prioritizing tactically important targets?",
          },
          ...
          >
            <div
              className="mono text-[9px] tracking-widest font-bold mb-0.5"
              style={{ color: c.textMuted }}
            >
              {title}
            </div>
            <div
              className="mono text-[8px] mb-2"
              style={{ color: c.textVeryDim }}
            >
              {q}
            </div>
            {data.length > 1 ? (
              <MiniChart data={data} color={color} height={52} />
            ) : (
              <div
                className="h-14 flex items-center justify-center mono text-[9px]"
                style={{ color: c.textVeryDim }}
              >
                — run simulation —
              </div>
      ...
      >
        <div
          className="mono text-[9px] tracking-widest font-bold mb-3"
          style={{ color: c.textMuted }}
        >
          UNCERTAINTY OVER TIME — ADAPTIVE SENSING LOOP
        </div>
        <div className="flex items-center gap-0 text-[9px] mono flex-wrap">
          {[
            ["Uncertainty ↑", c.purple],
            ["→ AI detects spike", c.textMuted],

            ["→ High-UNC region selected", c.blue],
            ["→ Scan executed", c.textMuted],

            ["→ Belief updated", c.textMuted],
            ["→ Uncertainty ↓", c.accent],
          ].map(([label, color], i) => (
...
function BenchmarksPage({ history, c }: { history: ScanRecord[] c: Palette }) {
  ...
  const adaptDetect =
    adaptRecords.filter((r) => r.detectedSignal).length /
    Math.max(adaptRecords.length, 1)
  ...
  const metrics = {
    ...
    ADAPT_SCAN: {
      ...
      infoGain: clamp(
        (history.reduce((s, r) => s + r.infoGain, 0) /
          Math.max(history.length, 1)) *
          1.1,
      ),

      efficiency: clamp(0.83 + adaptDetect * 0.1),
      ttd: 3.2,
    },
  }
                ...
                {cols.map((col) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        width: `${metrics[strat][col.key] * 100}%`,
                        background:
                          strat === "ADAPT_SCAN" ? col.color : col.color + "55",
                      }}
                    />
                  </div>
                ))}
      ...
      <div className="grid grid-cols-2 gap-3">
        {strategies.map((strat) => (
          <div
            ...
            style={{
              background: c.bgDarkCard,
              borderColor: strat === "ADAPT_SCAN" ? c.accent + "44" : c.border,
            }}
          >
            <div
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
            ...
            {([
              ...
              <div key={key}>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="mono text-[10px]" style={{ color: c.blue }}>
                    {(config as any)[key]}
                  </span>
                </div>
                <input
          ...
          >
            ...
            <div>
              <div
                className="mono text-[9px] tracking-widest font-bold mb-2"
                style={{ color: c.textMuted }}
              >
                PRIORITY MODE
              </div>
              <div className="grid grid-cols-3 gap-1">
                {[
                  ...
                  <button
                    key={label}
                    onClick={() => reset(strat as Strategy)}
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            {([
              ["RANDOM", "#4a7a99"],
              ["ROUND_ROBIN", "#38bdf8"],
              ["THREAT_PRIORITY", "#fbbf24"],
              ["ADAPT_SCAN", "#00e57a"],
            ] as [Strategy, string][]).map(([strat, color]) => (
              <button
                key={strat}
                onClick={() => reset(strat)}
                className="py-2 rounded border mono text-xs font-bold transition-all"
                style={
                  config.strategy === strat && running
          ...
          <div className="grid grid-cols-2 gap-2">
            {SCENARIOS.map((s) => (
              <button
                ...
                style={{
                  background:
                    config.scenario === s.id ? c.accent + "12" : c.bgDarkCard,
                  borderColor: config.scenario === s.id ? c.accent : c.border,
                }}
              >
                <div
                ...
                <div className="flex items-center gap-2 mt-1.5">
                  <span
                    className="mono text-[8px] px-1 py-0.5 rounded"
                    style={{
                      background:
                        s.difficulty === "Expert"
                          ? c.red + "22"
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 mb-3">
            {[
              {
                label: "INTRODUCE EMITTER",
                action: onIntroduceEmitter,
                color: c.yellow,
              },

              {
                label: "INCREASE NOISE",
                action: onIncreaseNoise,
                color: c.purple,
              },
              ...
              {
                label: "SIGNAL DISAPPEARS",
                action: onSignalDisappears,
                color: c.textMuted,
              },
          ...
          <div className="space-y-1 max-h-24 overflow-y-auto">
            {liveLog.length === 0 ? (
              <div className="mono text-[9px]" style={{ color: c.textVeryDim }}>
                — trigger events above to see live feedback —
              </div>
            ) : (
              liveLog
                .slice()
                ...
                .map((msg, i) => (
                  <div
                    key={i}
                    className="mono text-[9px]"
                    style={{ color: i === 0 ? c.yellow : c.textVeryDim }}
                  >
                    {msg}
                  </div>
                ))
...
function AIPanel({
  ...
  function send() {
    ...
    setTimeout(
      () => {
        setMessages((m) => [
          ...m,
          { role: "assistant", text: getAIResponse(text, step, history) },
        ])
        setTyping(false)
      },
      400 + Math.random() * 600,
  ...
  return (
    <div
      className="fixed right-0 top-0 bottom-0 z-50 flex flex-col shadow-2xl transition-all duration-300"
      style={{
        width: open ? "340px" : "0",
    ...
    >
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-3 space-y-3">
        {messages.map((msg, i) => (
          ...
          >
            <div
              className="max-w-[85%] px-3 py-2 rounded text-[11px] mono leading-relaxed"
              style={
                msg.role === "user"
                  ? {
        ...
        {typing && (
          <div className="flex justify-start">
            <div
              className="px-3 py-2 rounded text-[11px] mono"
              style={{ background: c.bgDarkCard, color: c.textMuted }}
            >
      ...
      <div className="p-3 border-t shrink-0" style={{ borderColor: c.border }}>
        <div className="flex gap-2">
          <input
            className="flex-1 text-[11px] mono px-3 py-2 rounded border outline-none"
            style={{
              background: c.bgDarkCard,
              borderColor: c.border,
              color: c.textPrimary,
          ...
          <button
            onClick={send}
            className="px-3 py-2 rounded border mono text-[10px] font-bold"
            style={{
...
function OverrideModal({
  ...
  open: boolean
  onClose: () => void
  onConfirm: (regionId: string, reason: string) => void
  ...
  return (
    ...
    >
      <div
        className="rounded-lg border w-[380px] overflow-hidden shadow-2xl"
      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          >
            ...
            <div className="mono text-sm font-bold" style={{ color: c.accent }}>
              SCAN {aiRegion}
            </div>
          </div>
          <div>
...
export default function App() {
  const [token, setToken] = useState(() =>
    localStorage.getItem("adapt_scan_token"),
  )
  ...
  useEffect(() => {
    ...
    const iv = setInterval(() => {
      ...
      if (lastTickTimeRef.current) {
        runSecsRef.current += (now - lastTickTimeRef.current) / 1000
        setElapsedSec(Math.floor(runSecsRef.current))
      }
  ...
  function addLiveEvent(msg: string) {
    setLiveLog((l) => [
      ...l.slice(-19),
      `${formatT(Math.floor(runSecsRef.current))} ${msg}`,
    ])

    setDecisionEvents((evs) => [
      ...evs,
      {
        id: eventIdRef.current++,
        step,
        elapsed: Math.floor(runSecsRef.current),
        type: "event",
        regionId: "",
        label: msg,
      },
  ...
  const runStep = useCallback(async () => {
    ...
    try {
      ...
      setBudgetUsed(
        Math.round(
          res.observation_state.budget_total -
            res.observation_state.budget_remaining,
        ),
      )
  ...
  const reset = useCallback(
    async (strategy: Strategy, configOverride?: Partial<SimConfig>) => {
      if (timerRef.current) clearInterval(timerRef.current)
  ...
  const highPriority = regions.filter(
    (r) => r.threatLevel > 0.7 && r.beliefProb > 0.5,
  ).length
  ...
  const budgetPct =
    config.scanBudget > 0
      ? Math.round((budgetUsed / config.scanBudget) * 100)
      : 0
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <div
              className="w-1.5 h-1.5 rounded-full"
              style={{
                background: running ? c.accent : c.textVeryDim,
                boxShadow: running ? `0 0 6px ${c.accent}` : "none",
              }}
            />
            <span
              className="mono text-[10px] font-bold tracking-widest"
              style={{ color: running ? c.accent : c.textMuted }}
            >
          ...
          <span className="mono text-[10px]" style={{ color: c.textMuted }}>
            SCENARIO <span style={{ color: c.blue }}>{config.scenario}</span>
          </span>
          <span className="mono text-[10px]" style={{ color: c.textMuted }}>
            {t("step")}{" "}
            <span style={{ color: c.blue }}>
          ...
          <span className="mono text-[10px]" style={{ color: c.textMuted }}>
            <span style={{ color: c.yellow }}>{formatT(elapsedSec)}</span>
          </span>
          <span className="mono text-[10px]" style={{ color: c.textMuted }}>
            {t("budget")}{" "}
            <span style={{ color: budgetPct > 80 ? c.red : c.yellow }}>
              {budgetPct}%
            </span>
          </span>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="relative" onClick={(e) => e.stopPropagation()}>
            ...
            >
              {t("langLabel")}{" "}
              <span style={{ color: c.blue }}>{LANG_LABELS[lang]}</span>{" "}
              <span style={{ color: c.textVeryDim }}>▾</span>
            </button>
            {showLangMenu && (
              <div
                className="absolute right-0 top-8 z-40 rounded border shadow-lg overflow-hidden"
                style={{
                  background: c.bgPanel,
                  borderColor: c.border,
                  minWidth: "110px",
              ...
              >
                {(Object.keys(LANG_NAMES) as Lang[]).map((l) => (
                  ...
                  >
                    <span className="w-5">{LANG_LABELS[l]}</span>
      ...
      {error && (
        <div
          className="px-4 py-2 border-b text-xs mono flex items-center justify-between shrink-0"
          style={{
            background: c.red + "22",
            color: c.red,
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {activePage === "overview" && (
          <>
            ...
            <div
              className="flex flex-1 overflow-hidden border-r"
              style={{ borderColor: c.border }}
            >
              {/* Spectrum + belief */}
              <div className="flex-1 flex flex-col overflow-hidden">
                ...
                >
                  <span
                    className="mono text-[9px] tracking-widest shrink-0"
                    style={{ color: c.textMuted }}
                  >
                    {t("currentIntel")}
                  </span>
        ...
        {activePage === "settings" && (
          <SettingsPage
            ...
            onUncSpike={uncertaintySpike}
            onSignalDisappears={signalDisappears}
            onResetEnv={() => reset(configRef.current.strategy)}
      ...
      {/* ── Footer ── */}
      <div
        className="px-5 py-1.5 border-t flex items-center shrink-0 text-[9px] mono"
        style={{
          background: c.bgPanel,
          borderColor: c.border,
          color: c.textVeryDim,
      ...
      <OverrideModal
        ...
        onConfirm={(regionId, reason) => {
          ...
          addLiveEvent(
            `⊘ Operator override: ${regionId} (${reason || "no reason"})`,
          )
        }}
        regions={regions}
